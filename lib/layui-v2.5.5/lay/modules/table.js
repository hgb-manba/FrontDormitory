...
layui.define(['laytpl', 'laypage', 'layer', 'form', 'util','axios'], function(exports){
  ...
  var $ = layui.$
      ...
      //主模板
      ,TPL_MAIN = ['<div class="layui-form layui-border-box {{d.VIEW_CLASS}}" lay-filter="LAY-table-{{d.index}}" lay-id="{{ d.data.id }}" ' +
      'style="{{# if(d.data.width){ }}width:{{d.data.width}}px;{{# } }} {{# if(d.data.height){ }}height:{{d.data.height}}px;{{# } }}">'
